...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/unity-spin-the-wheel.loader.js";
var config = {
...
function submitUserDetails() {
    ...
    // Send the collected data back to Unity
    // unityInstance.SendMessage('GameManager', 'ReceiveUserDetails', username + ',' + mobile);
